...
// export type IncomeIconProps = {
//   type?: 'income' | 'expense' | 'transactions' | undefined;
// };
export type IconProps = {
  color?: boolean;
};

export function IncomeIcon(color: IconProps) {
  // const color = ChooseiconColor(type);
  return (
    <svg
      width='24'
      height='24'
