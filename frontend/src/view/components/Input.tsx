    ...
    return (
      <div className='relative'>
        <input
          ...
          name={name}
          id={inputId}
          className={cn('w-full bg-white rounded-lg border border-gray-500 text-gray-800 px-3 h-[52px] pt-4 peer placeholder-shown:pt-0 focus:outline-slate-600 transition-all',
